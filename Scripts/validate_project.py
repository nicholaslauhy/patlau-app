...
required_link_markers = {
    ...
    'path: "/api/operations/summary"': "website-linked operations command centre",
    "operations-command-centre": "post-login role-aware operations summary",
    '.navigationTitle("Workspace")': "dedicated operational workspace",
